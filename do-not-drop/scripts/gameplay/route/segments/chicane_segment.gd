...
func _build() -> void:
	...
	_block("ChicaneLeft", Vector3(4.4, 0.8, 1.0), Vector3(-3.8, 0.4, -length * 0.35), CONCRETE)
	_box("ChicaneLeftWarning", Vector3(4.44, 0.24, 1.02), Vector3(-3.8, 0.61, -length * 0.35), WARNING)
	_block("ChicaneRight", Vector3(4.4, 0.8, 1.0), Vector3(3.8, 0.4, -length * 0.65), CONCRETE)
